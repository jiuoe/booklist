...
public class FragmentThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                FragmentThree.this.getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
        ...
        mapView.getMap().setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Toast.makeText(FragmentThree.this.getContext(), "Marker clicked", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
        return rootView;
    ...
    private void AddMarkersOnMap(List<ShopLocation> locations) {
        BitmapDescriptor bitmap= BitmapDescriptorFactory.fromResource(R.drawable.home_foreground);
